...
const AboutPage = () => {
  return (
    ...
    // and layout is set up for responsive stacking.
    <div className="min-h-screen bg-gray-50 text-gray-800 flex flex-col
      ...
      <main className="flex-grow"> {/* flex-grow ensures main content pushes footer down */}
        {/* Hero Section - Responsive padding, text sizing, and content width */}
        <section className="relative bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-20 px-4 text-center overflow-hidden">
          {/* Background shapes for visual interest (fixed, but overlay works across sizes) */}
        ...
        {/* Our Mission Section - Responsive text and max-width */}
        ...
        {/* Our Story & Values Section - Responsive grid and image sizing */}
        <section className="py-16 px-4 bg-gray-50
                                 dark:bg-gray-900 transition-colors duration-300">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            {/* Text content, changes order on medium screens */}
            ...
            {/* Image, changes order on medium screens and scales responsively */}
        ...
        {/* Why Choose Us - Features Section - Fully responsive grid for features */}
        <section className="py-16 px-4 bg-white
                                 dark:bg-gray-800 transition-colors duration-300">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {/* Feature Cards: Each card is independently responsive */}
              {/* Feature 1 */}
        ...
        {/* Call to Action Section - Responsive text and button sizing */}
